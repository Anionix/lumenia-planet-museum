...
export function MuseumCharacter({ step, direction, paused }: { step: number; direction: number | null; paused: boolean }) {
  const state = characterAnimationForStudioStep(step);
  const cell = direction === null ? null : characterDirectionCell(direction);
  return <span aria-hidden="true" data-museum-character="8b952955-8da1-53ed-8cc0-87934f160bfa"
