...
const publicDirectory = 'characters/william-morris';
...
export async function inspectCharacterAsset(directory) {
  ...
  try {
    if (receipt.status !== 'pass' || receipt.artifactIdentifier !== '8b952955-8da1-53ed-8cc0-87934f160bfa' ||
    ...
    const required = ['validation-extended.json', 'chroma-despill-extended.json', 'direction-blind-validation.json', 'direction-semantics.json', 'visual-review.json'];
