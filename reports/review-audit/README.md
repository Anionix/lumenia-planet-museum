...
実行: 01a0aae3-3852-7622-bea0-e0231e2b1008
資料の版（完全監査）: sha256:e56813b1ed4b504e78fb90e57be76a4ca318278c6e6a41e4309482112fee9f32
ルートのみの版: sha256:e2848a5d3243b0f7f5b56ca16b9132acf4c0612c4c0adee33566482f1cf4e973
...
現行の完全監査対象は source-manifest.json に記録した287ファイルです。ルートのみの版は補助的に保持し、惑星資料の検算は完全監査版に結び付けています。Git の保存版検査は前回の版を対象にした記録として保持し、現行版の資料版とは混同しません（[記録](git-archive.json)）。
